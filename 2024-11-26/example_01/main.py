...
def create():
    ...
    def new_text():
        return (
            ltk.Text(f"Text created at {ltk.get_time()}s")
            .css("color", "white")
    ...
    return (
        ltk.VBox(
            ...
            ltk.Container(
                ...
                ltk.Button("Remove first child", remove_first_child).addClass(
                    "dom-remove"
                ),
                ltk.Button("Remove first list", remove_first_list).addClass(
                    "dom-remove"
                ),
